...
public class TestCase4_PrintButton {
		...
		driver.findElement(By.xpath("//div[@class='main_btn_action']")).click();WebElement usernametextbox = driver.findElement(By.id("userLoginId"));
		...
		WebElement print=driver.findElement(By.xpath("//*[@id='list_ehr_needHelp']/i"));
		print.click();
