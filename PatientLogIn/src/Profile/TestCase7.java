...
public class TestCase7 {
		...
		public static void main(String[] args) {
			...
			PersonalDetail.click();
			 ...
			 WebElement tooltip= driver.findElement(By.xpath("//*[@id='form']/div[2]/div[6]/div"));
			 String tooltipText = tooltip.getAttribute("title"); 
			 if(tooltipText.contains("Enter Patient's Last Name"))
				{
					System.out.println("Enter Patient's Last Name tooltip is present");
				}
			 else{System.out.println("Unable to find tooltip for Last Name");}
	}
